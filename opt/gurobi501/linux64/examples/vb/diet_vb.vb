...
Class diet_vb
    Shared Sub Main()
        Try
            ...
            Dim Categories As String() = New String() {"calories", "protein", "fat", "sodium"}
            ...
            ' Set of foods
            Dim Foods As String() = New String() {"hamburger", "chicken", "hot dog", "fries", _
                                                  "macaroni", "pizza", "salad", "milk", _
                                                  "ice cream"}
            ...
            For j As Integer = 0 To nFoods - 1
                buy(j) = model.AddVar(0, GRB.INFINITY, cost(j), GRB.CONTINUOUS, Foods(j))
            Next
    ...
    Private Shared Sub PrintSolution(ByVal model As GRBModel, ByVal buy As GRBVar(), ByVal nutrition As GRBVar())
