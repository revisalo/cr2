...
Subject.create(code: 'MATE-1', credits: 1, name: 'Materia 1', pensum_id: '1', capacity: 50)

Subject.create(code: 'MATE-2', credits: 1, name: 'Materia 2', pensum_id: '1', capacity: 50)

Subject.create(code: 'MATE-3', credits: 1, name: 'Materia 3', pensum_id: '1', capacity: 50)
