...
class FoldersControllerTest < ActionController::TestCase
  ...
  test "should create folder" do
    assert_difference('Folder.count') do
      post :create, folder: { code: @folder.code, docid: @folder.docid, name: @folder.name, semester: @folder.semester, year: @folder.year }
    end
  ...
  test "should update folder" do
    put :update, id: @folder, folder: { code: @folder.code, docid: @folder.docid, name: @folder.name, semester: @folder.semester, year: @folder.year }
    assert_redirected_to folder_path(assigns(:folder))
  end
